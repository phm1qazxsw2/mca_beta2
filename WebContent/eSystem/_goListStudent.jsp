...
<%
	...
	if(pageNumber !=1)
	{
		...
		out.println("<a href=\"listStudent.jsp?depart="+departId+
			"&classx="+classId+"&level="+level+"&pageNum="+lastPage+"&orderNum="+orderNum+"\">上一頁</a>");
	}
	for(int j=0;j<pageTotal;j++)
	{
		...
		{
			out.println("<a href=\"listStudent.jsp?depart="+departId+
			"&classx="+classId+"&level="+level+"&pageNum="+jx+"&orderNum="+orderNum+"\">"+jx+"</a>");
		}
	}
	if(pageNumber !=pageTotal)
	{
		int lastPage=pageNumber+1;
		out.println("<a href=\"listStudent.jsp?depart="+departId+
			"&classx="+classId+"&level="+level+"&pageNum="+lastPage+"&orderNum="+orderNum+"\">下一頁</a>");
	}
...
{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=2">>>>性別</a>
<%
}else{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=1"><<<性別</a>
<%
}
%>
</b></td>
...
{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=4">>>>單位</a>
<%
}else{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=3"><<<單位</a>
<%
}
%>
...
{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=6">>>>班級</a>
<%
}else{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=5"><<<班級</a>
<%
}
%>
...
{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=8">>>>年級</a>
<%
}else{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=7"><<<年級</a>
<%
}
%>
</b>
...
{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=10">>>>生日</a>
<%
}else{
%>
<a href="listStudent.jsp?depart=<%=departId%>&classx=<%=classId%>&level=<%=level%>&pageNum=<%=pageNumber%>&orderNum=9"><<<生日</a>
<%
}
%>
