<%@ page buffer="32kb" language="java"  import="web.*,jsf.*,java.util.*,java.text.*" contentType="text/html;charset=UTF-8"%>
...
<%
	...
	if(jp.addCostOwnertrade(ow, _ws.getSessionBunitId()))
    {
        response.sendRedirect("addCostOwerResult.jsp");
    }else{
%>
    <br>
    <br>
