...
<%
    ...
    SchDef s = SchDefMgr.getInstance().find("id=" + copyId);
    ArrayList<SchDef> defs = new ArrayList<SchDef>();
    defs.add(s);
    SchMembrData data = new SchMembrData(defs);
%>

<%@ include file="schedule_month.jsp"%>
<script src="js/formcheck.js"></script>
<script>
function preSelectMonth(m, f, data)
{
...
<body>
<div class=es02>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="pic/add.gif" border=0>&nbsp;複製班表</font></div>
...
<table width="100%" border=0 cellpadding=0 cellspacing=0>
	<tr bgcolor=#ffffff align=left valign=middle> 
        ...
        <td>
            <form name="f1" action="schedule_copy2.jsp" method="post" onsubmit="return doCheck(this);">
            ...
            <td bgcolor="#e9e3de">
                ...
                <tr bgcolor=#ffffff class=es02 align=left valign=middle>
                    ...
                    <td>
                           <select name="month" onchange="checkMonth(this, this.form, '<%=s.getDays()%>');">
                ...
                <tr bgcolor=#ffffff class=es02 align=left valign=middle>
                    ...
                    <td nowrap>
                        <%=data.getUserNames(s, null)%> (複製後可修改)                   
                    </td>
                </tr>
            </table>
            </td>
...
<script>
    ...
    document.f1.note.value = '<%=phm.util.TextUtil.escapeJSString(s.getNote())%>';
    preSelectMonth(mon, document.f1, '<%=s.getDays()%>');
</script>
