...
<%
    ...
    try { 
        ...
        //if ((dnum + damount)>ci.getMyAmount())
        ...
        vsvc.updateChargeItemMembr(ci, ud2.getId(), ci.getChargeName()+ "折扣-" + dtype.getDiscountTypeName());

        if (affected_pays.size()>0)
            vsvc.genVoucherForBillPays(affected_pays, ud2.getId(), "折扣-" + dtype.getDiscountTypeName());
