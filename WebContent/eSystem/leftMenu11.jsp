...
<img src=pic/arrow02<%=(leftMenu==1)?"r":""%>.gif border=0 align=absmiddle><font color=white>現金流概況</font></td>
</tr>
...
%>
	...
	<a href="cashaccountIndex.jsp" class=an01>現金帳戶</a></td>
</tr>
...
<%
    ...
    {
        if (pZ2.getWorkflow()!=4) {
%>

<tr align=left valign=middle>
<td width="131" class=es02r><img src=pic/arrow01.gif border=0 align=absmiddle>
<a href="query_cheque.jsp" class=an01>未兌現支票</a></td>
</tr>
...
<a href="addInsideTrade.jsp" class=an01>新增內部轉帳</a></td>
</tr>
...
<td width="131" class=es02r>
<img src=pic/arrow01.gif border=0 align=absmiddle>
<a href="listInsidetrade.jsp" class=an01>內部轉帳紀錄</a></td>
</tr>
...
<tr align=left valign=middle>
<td bgcolor=#696a6e width="131" background=pic/left01.gif class=es02r>
<img src=pic/arrow02<%=(leftMenu==3)?"r":""%>.gif border=0 align=absmiddle><font color=white>帳戶管理 </font></td>
</tr>
...
<tr align=left valign=middle>
<td width="131" class=es02r><img src=pic/arrow01.gif border=0 align=absmiddle>
<a href="listTradeaccount.jsp" class=an01>零用金帳號</a></td>
</tr>
...
<tr align=left valign=middle>
<td width="131" class=es02r><img src=pic/arrow01.gif border=0 align=absmiddle>
<a href="steupOwner.jsp" class=an01>股東帳戶</a></td>
</tr>
