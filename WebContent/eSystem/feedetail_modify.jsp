...
<br>
<div class=es02> 
<b>&nbsp;&nbsp;&nbsp;<img src="pic/fix.gif" border=0>編輯收費明細-<%=ci.getChargeName()%> for <%=ci.getMembrName()%> </b>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:history.go(-1)"><img src="pic/last.gif" border=0>回上一頁</a>
</div>
<table width="100%" border=0 cellpadding=0 cellspacing=0><tr align=left valign=top><td background=pic/h01.gif><img src="pic/h01.gif" height=1 border=0 alt=""></td></tr></table>
<br>

<form action="feedetail_modify2.jsp" method="post" onsubmit="return check_submit(this);">
...
<% if (outsourcing) { 
    Membr m = MembrMgr.getInstance().find("id=" + fd.getPayrollMembrId());    
%>
...
<% } %>
		...
		<tr bgcolor=#f0f0f0 class=es02>
			<td>單價</td>
			<td bgcolor="#ffffff">
			<input type=text name="unitPrice" size=5 value="<%=mnf.format(fd.getUnitPrice())%>">
			</td>
		</tr>
