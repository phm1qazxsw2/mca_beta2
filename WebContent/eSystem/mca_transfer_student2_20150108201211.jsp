...
<%
    ...
    try {           
        ...
        System.out.println("#b campus=" + campus + " membrId=" + s.getMembrId() + " studId=" + s.getStudId() + " bunitId=" + membr.getBunitId());
        if (campus!=membr.getBunitId()) {
        	System.out.println("#0 studId=" + s.getStudId());	
            ...
            mmgr.save(membr);
            System.out.println("#6 campus=" + campus);	            
