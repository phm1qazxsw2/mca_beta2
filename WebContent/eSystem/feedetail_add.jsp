...
{
<% if (outsourcing) { %>
    if (typeof f.executeMembrId=='undefined' || !IsNumeric(f.executeMembrId.value) || eval(f.executeMembrId.value)==0) {
...
<div class=es02> 
<b>&nbsp;&nbsp;&nbsp;<img src="pic/redfix.png" border=0>&nbsp;新增收費明細-<%=ci.getChargeName()%> for <%=ci.getMembrName()%> </b>
<div>

<div class=es02 align=right>
<a href="javascript:history.go(-1)"><img src="pic/last.gif" border=0>&nbsp;回上一頁</a>&nbsp;&nbsp;&nbsp;</div>
...
<form action="feedetail_add2.jsp" method="post" onsubmit="return check_submit(this);">
...
<% } %>
		...
		<tr bgcolor=#f0f0f0 class=es02>
			<td>單價</td>
			<td bgcolor="#ffffff">
			    <input type=text name="unitPrice" size=7 value="<%=ci.getChargeAmount()%>">
			</td>
		</tr>
