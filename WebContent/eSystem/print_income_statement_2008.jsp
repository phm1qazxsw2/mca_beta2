...
<%
    ...
    try {
        ...
        Date curMonthStart = sdf4.parse("2008/01/01");
        Date curMonthEnd = sdf4.parse("2008/12/31");
        Date nextMonthStart = sdf4.parse("2009/01/01");
...
//## prepare some datastructure
        ...
        */
        ...
        String bill_brids = new RangeMaker().makeRange(bills, "getBillRecordId");        
        String salary_brids = new RangeMaker().makeRange(salaries, "getBillRecordId");        
System.out.println("## bill_brids=" + bill_brids);
System.out.println("## salary_brids=" + salary_brids);
        ArrayList<BillRecordInfo> salaryRecords = BillRecordInfoMgr.getInstance().
            retrieveList("billrecord.id in (" + salary_brids + ")", "");
    
        // 找出這批record 所有的 charge, 并放到 feeMap 里
        ArrayList<ChargeItemMembr> all_fees = ChargeItemMembrMgr.getInstance().
            retrieveList("chargeitem.billRecordId in (" + bill_brids + ")", "");
...
//###### end of 收入, start of 支出
        ...
        while (brIter.hasNext()) {
            ...
            cell2 = new PdfPCell(new Paragraph("    "+br.getBillName()+" " + sdf.format(br.getMonth()),font12));
            cell2.setBorderColor(new Color(255, 255, 255));
            cell2.setFixedHeight(20f);
            cell2.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell2.setVerticalAlignment(Element.ALIGN_MIDDLE);
