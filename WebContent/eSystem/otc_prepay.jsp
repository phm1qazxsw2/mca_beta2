...
function calc_sum()
{
    var d = document.getElementById("payfield");
    ...
    d.innerHTML = "<input type=text name=payMoney size=10 value=''>";
...
function checkForm(f)
{
    ...
    if (!IsPositive(f.payMoney.value, true)) {
        alert("請輸入正確的金額");
        f.payMoney.focus();
        return false;
    }
...
<br>
<div class=es02><b>&nbsp;&nbsp;&nbsp;&nbsp;<%=membr.getName()%>-臨櫃預收繳款</b>
...
%>
<form name=f1 action="otc_prepay2.jsp" method="post" onsubmit="return checkForm(this)"> 
