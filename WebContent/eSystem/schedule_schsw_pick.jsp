...
%> 
<form name="f1" action = "schedule_schsw_pick2.jsp" method="post">    
...
document.getElementById('submitbutton').innerHTML = '<input type=button value="新增換班" onclick="return(doSubmit())">';
<%
