...
<b><%=record.getName()%>-薪資鐘點費新增設定 for <%=m.getName()%></b>
...
<br><br>
<form name="f1" action="salarybillrecord_add_adv2.jsp" method="post" onsubmit="return check();">
    ...
    <td width=600 valign=top class=es02>
        ...
        <table width="60%" height="" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr bgcolor=#f0f0f0 class=es02>
                ...
                <td nowrap>數量</td>
                <td>=</td>
                <td nowrap>&nbsp;&nbsp;&nbsp;小計&nbsp;&nbsp;&nbsp;<a href="salarybillrecord_add.jsp?brid=<%=brid%>&mid=<%=mid%>&backurl=<%=java.net.URLEncoder.encode(backurl)%>">一般設定<a>
                </td>
            </tr>
        <%            
            ...
            <tr bgcolor=white class=es02 valign=center height=30>
                ...
                <td nowrap><input type=text size=7 name="date_<%=bi.getBillItemId()%>" value="<%=sdf.format(new Date())%>"></td>                         <td>
        ...
        <tr>
            <td align=middle colspan=3>
                    <input type="submit" value="新增薪資項目">
            </td>
        </tr>
        </table>
