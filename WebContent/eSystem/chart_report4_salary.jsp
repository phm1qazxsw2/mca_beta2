...
<%
    _ws.setBookmark(ud2, "薪資付款統計 - " + nowMonth);
...
<%
    ...
    while (viaiter.hasNext()) {
        ...
        switch(via){
            ...
            case 100: vianame="櫃臺現金"; break;
            case 101: vianame="薪資轉帳"; break;
        }
...
%>
    ...
    <br>
    <br>
    <div class=es02>&nbsp;&nbsp;<b>付款日期統計:</b></div><br>
    ...
    %>
            <tr bgcolor=#ffffff class=es02>
                ...
                <td>
                    ...
                    {
                        String xxString=java.net.URLEncoder.encode("salaryrecord_chart.jsp?month="+monstr+"&type=4");
                    %>
                        <a href="salary_detail.jsp?rid=<%=pInfo.get(v).getBillRecordId()%>&sid=<%=pInfo.get(v).getMembrId()%>&backurl=<%=xxString%>"><font color=blue><%=pInfo.get(v).getMembrName()%></font></a>,
                    <%  
                    }
                    %>
                </tD>
