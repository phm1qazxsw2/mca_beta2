...
<form name="f2" action="sendGroupEmail2.jsp" onsubmit="return check();">
        <tr bgcolor=ffffff class=es02>
...
%>  
      ...
      <tr bgcolor=ffffff class=es02>
            <td bgcolor=f0f0f0>Email標題</td>
            <td>
                <input type=text name="title" size="70">
            </td>
        </tr>
        <tr bgcolor=ffffff class=es02>
            <td bgcolor=f0f0f0>Email內容</td>
            <td>
                <textarea rows=15 cols=60 name="sendContent"></textarea>
                <br>
                說明1: 請以<font color=blue> xxx </font> 代替學生姓名,系統將自動轉換. <BR>
            </td>
        </tr>
        <tr>
...
function check_all(c) {
    ...
    {
        window.location="sendGroupEmail.jsp?tagId="+tagId;
    }
</script>
