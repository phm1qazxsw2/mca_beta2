...
<%
    ...
    int unpaidBunitId = bh.getUnpaidBunitId(b.getId());
%>
...
&nbsp;&nbsp;&nbsp;<img src="pic/tag1.png" border=0>&nbsp;修改單位
    ...
    <center>
        <form name="f1" action="company_bunit_add2.jsp" method="post" onsubmit="return do_check(this)">
...
-->
            ...
            <tr class=es02 bgcolor=ffffff>
                ...
                <td>
                    <select name="unpaidBunitId">
                    <option value="0">-- 無 --
                <%
                    for (int i=0; i<bunits.size(); i++) {
                        %><option value="<%=bunits.get(i).getId()%>" <%=(bunits.get(i).getId()==unpaidBunitId)? "selected":""%> ><%=bunits.get(i).getLabel()%><%
                    }
                %>
                    </select>
                </td>
