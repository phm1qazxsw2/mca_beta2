...
<%          
    ...
    try {            
        ...
        for (int i=0; i<lines.length; i++) {
            ...
            String ophone      = TextUtil.trim(tokens[19], "\"");
            String fathercell   = TextUtil.trim(tokens[20], "\"");
            String mothercell   = TextUtil.trim(tokens[21], "\"");
            String addr1      = TextUtil.trim(tokens[22], "\"");
            String district_eng      = TextUtil.trim(tokens[23], "\"");
            String city_eng      = TextUtil.trim(tokens[24], "\"");
            String postcode1  = TextUtil.trim(tokens[25], "\"");
            String c_addr      = TextUtil.trim(tokens[26], "\"");
            String c_district  = TextUtil.trim(tokens[27], "\"");
            String c_city      = TextUtil.trim(tokens[28], "\"");
            String billTo      = TextUtil.trim(tokens[29], "\"");
            String bill_st      = TextUtil.trim(tokens[30], "\"");
            String bill_city     = TextUtil.trim(tokens[31], "\"");
            String bill_postcode      = TextUtil.trim(tokens[32], "\"");
            String fatheremail  = TextUtil.trim(tokens[33], "\"");
            String motheremail = "";
            if (tokens.length>34)
                motheremail  = TextUtil.trim(tokens[34], "\"");
