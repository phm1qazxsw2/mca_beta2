...
<%          
    ...
    try {            
        ...
        Bunit bu = new BunitMgr(tran_id).find("label='北門校'");
        ...
        for (int i=0; i<lines.length; i++) {
            ...
            Student2 student = smgr.findX("studentName='" + studentName + "'", 
                bh.getStudentSpace("bunitId", bu.getId()));
            Membr membr = null;
            boolean exist = true;
            if (student!=null) {
                ImportStudent.parseLeader(tokens, student, bu.getId());
                smgr.save(student);
