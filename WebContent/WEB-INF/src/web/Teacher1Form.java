...
public class Teacher1Form implements ValidatedElement {

    private String error = "";

    private OptionsElement	status	=	new OptionsElement();
    private OptionsElement	depart	=	new OptionsElement();
    private OptionsElement	position	=	new OptionsElement();
    ...
    public String getPositionSelectionAttr(String s) { return position.selectionAttr(s); }
    ...
    public void setPosition(String[] s) { position.setValue(s); }
...
// ================================== 
// <jsp:useBean id='form' scope='request' class='beans.app.forms.Teacher1Form'/>
